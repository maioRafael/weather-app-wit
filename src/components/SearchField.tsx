...
import { SearchForm } from "../styles/style";

type Properties = {
    onSearch: ( term: String ) => void
}

export const SearchField = ( props: Properties ) => {
    ...
    return (
        ...
        <SearchForm>
            <form className="search" onSubmit={submitHandler}>
                <input type="text" className="search-bar" placeholder="Search city" required ref={searchTermRef}/>
                <button type="submit">
